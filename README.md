...
[![GoDoc](https://godoc.org/github.com/ambikuk/go-api-marketplace?status.png)](http://godoc.org/github.com/ambikuk/go-api-marketplace)
[![Build Status](https://travis-ci.org/ambikuk/go-api-marketplace.svg?branch=master)](https://travis-ci.org/ambikuk/go-api-marketplace)
[![Coverage Status](https://coveralls.io/repos/github/ambikuk/go-api-marketplace/badge.svg?branch=master)](https://coveralls.io/github/ambikuk/go-api-marketplace?branch=master)
[![Go Report](https://goreportcard.com/badge/github.com/ambikuk/go-api-marketplace)](https://goreportcard.com/report/github.com/ambikuk/go-api-marketplace)
...
`$GOPATH/ambikuk/go-api-marketplace` directory:
...
* move the directory `$GOPATH/github.com/ambikuk/go-api-marketplace` to `$GOPATH/github.com/abc/xyz`
* do a global replacement of the string `github.com/ambikuk/go-api-marketplace` in all of
